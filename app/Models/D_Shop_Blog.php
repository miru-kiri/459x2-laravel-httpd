...
class D_Shop_Blog extends Model
{
    use HasFactory;

    protected $table = 'd_shop_blog';
    ...
    public function scopeFetchFilterSiteIdData(object $query,array $filter):object
    {
        return $query
            ...
            ->where("d_shop_blog.delete_flg",0)
            ...
            ->leftjoin("m_site","m_site.id","d_shop_blog.site_id")
     ...
     * @return object
     */
    public function scopeFetchFilterSiteIdPulicData(object $query,array $filter):object
    {
        return $query
            ->where("m_site.deleted_at", 0)
			->where("m_site.is_public", 1)
     ...
     * @return object
     */
    public function scopeFetchSiteIdFristData(object $query,array $siteIdAry)
    {
        try {
            return $query
                ->where("m_site.deleted_at", 0)
