    ...
    <div class="container" style="width: 360px;">
      <img class="my-5" src="{{ asset('img/logo.png') }}" style="width: 270px"/>
          <div class="form-group">
            ...
            <!-- <small class="fw-bold" style="color: #EF747D">ハイフンなしで入力してください。</small><br> -->
            <small class="fw-bold" style="color: #EF747D">有効期限は、3分です。</small>
          </div>   
  ...
  <script>
    ...
    $('#submit_btn').on('click', function() {
      ...
      $.ajax({
        ...
        type: "POST",
        contentType: "application/json",
        url: "{{ route('mypage.password.forget') }}",
        dataType:"json",
      }).done(function(data, status, jqXHR) {
        if(data.result == 0) {
          // 成功時リロード
          ...
          location.href = "{{ route('mypage.password.code') }}"
        } else {
