...
@section('title','四国最大級のおすすめ風俗優良店まとめサイト|コスモ天国ネット メール変更ページ')
@section('description','有名な道後歌舞伎通りのヘルス・高松城東のソープ風俗情報満載の天国ネット！他にも松山・新居浜・今治のセクキャバ・メンズエステ・アロマエステ・琴平のソープなど様々な風俗や有名な観光地情報を紹介！メール変更ページです！')
...
<section>
  <div class="container mt-3"  style="width: 360px;">
    <div class="text-center my-3">
      <p class="fw-bold mb-4 fs-5" style="color: #016DB7;">メールアドレス変更手続き</p>
