...
class CreateDSiteCastLogTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('d_site_cast_log', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('cast_id')->default(0)->comment('サイトID');            
    ...
    {
        Schema::dropIfExists('d_site_cast_log');
    }
}
