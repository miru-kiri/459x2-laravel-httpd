...
class CreateDSiteDetailTabTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('d_site_detail_tab', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('master_detail_id')->default(0)->comment('m_site_detail_tab.id');
    ...
    {
        Schema::dropIfExists('d_site_detail_tab');
    }
}
