...
class CreateSiteAreaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('site_area', function (Blueprint $table) {
            ...
            $table->integer('area_id')->default(0)->comment('エリアID');
        });
    }
