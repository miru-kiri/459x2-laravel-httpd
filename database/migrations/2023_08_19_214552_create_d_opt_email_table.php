...
class CreateDOptEmailTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('d_opt_email', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('email')->nullable()->comment('電話番号');
    ...
    {
        Schema::dropIfExists('d_opt_email');
    }
}
