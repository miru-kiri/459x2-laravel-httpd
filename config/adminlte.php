...
return [
    ...
    */
    ...
    'logo' => '<small>天国ネット管理画面</small>',
    'logo_img' => 'vendor/adminlte/dist/img/tengoku_woman.png',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/tengoku_woman.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
    ...
    */
    ...
    'admin_menu' => [
        ...
        [
            'text' => '本日の出勤',
            'url'  => 'admin/cast/imasugu?tab=imasugu',
            'icon' => 'fas fa-fw fa-user',
        ],
        [
            'text' => 'キャスト出勤管理',
            'url'  => 'admin/cast/shedule',
        ...
        [
            'text' => 'メッセージ管理(店舗)',
            'url'  => 'admin/message/shop',
            'icon' => 'fas fa-fw fa-envelope-open-text',
        ],
        [
            'text' => 'メッセージ管理(キャスト)',
            'url'  => 'admin/message/cast',
            'icon' => 'fas fa-fw fa-envelope-open-text',
        ],
        [
            'text' => '口コミ管理',
        ...
        [
            'text' => '予約統計管理',
            'url'  => 'admin/reserve/statistics',
            'icon' => 'fas fa-fw fa-chart-pie',
        ],
        [
            'text' => '記事管理',
            'url'  => 'admin/blog/template',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => '店舗設定',
                    'url'  => 'admin/master/shop',
                    'icon' => 'fas fa-fw fa-store-alt',
                ],
                [
                    'text' => 'サイト設定',
                    'url'  => 'admin/master/site',
                    'icon' => 'fas fa-fw fa-hotel',
                ],
                [
                    'text' => 'エリア設定',
                    'url'  => 'admin/master/area',
                    'icon' => 'fas fa-fw fa-map',
                ],
                [
                    'text' => 'ジャンル設定',
                    'url'  => 'admin/master/genre',
                    'icon' => 'fas fa-fw fa-bezier-curve',
                ],
                [
                    'text' => 'オプション設定',
                    'url'  => 'admin/master/option',
                    'icon' => 'fas fa-fw fa-map',
                ],
                [
                    'text' => 'システム・料金管理',
                    'url'  => 'admin/master/system',
                    'icon' => 'fas fa-fw fa-dollar-sign',
                ],
                [
                    'text' => 'サイト質問管理',
                    'url'  => 'admin/master/question',
    ...
    'cast_menu' => [
        ...
        [
            'text' => 'ダッシュボード',
            'url'  => 'admin/dashboard/cast',
            'icon' => 'fas fa-fw fa-tachometer-alt',
        ],
        [
            'text' => 'プロフィール設定',
            'url'  => 'admin/cast/profile',
            'icon' => 'fas fa-fw fa-user',
        ],
        [
            'text' => 'ブログ管理',
        ...
        'Select2' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/select2/js/i18n/ja.js',
                ],
                [
                    'type' => 'css',
                    'asset' => true,
        ...
        'Jquery-validation' => [
            ...
            'files' => [
                ...
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/jquery-validation/localization/messages_ja.min.js'
                ],
            ]
        ],
        //カスタム
