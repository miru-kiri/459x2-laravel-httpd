...
$(document).ready(function(){
   ...
   $(".mrt_xxx_video_div").on('click', function(){
      $.mrt_controls_exe();
      return false;
   });
   
   $("#mrt_xxx_video, .mrt_xxx_video_div, .mrt_mv_control_div").on('touchenter touchmove mouseenter click', function(){
      $.mrt_controls_exe();
      $(this).movingstate({
         start: function(){
   ...
   $(".mrt_xxx_video_div").on('touchleave mouseleave', function(){
      $(".mrt_mv_control_div").hide();
      return false;
   });
   ...
   $.wrsz();
               ...
               $(".mrt_mv_play_on_btn").one('click', function(){
                  $(".mrt_play_tbl").remove();
                  $(".mv_cm_box").hide();
            ...
            $(".mrt_play_mv").one('click', function(){
               $.up1_count();
               return false;
            }); //mrt_play_mv
            */
    ...
    $.event.special.mousestop = {
        setup: function(data) {
            $(this).data('mousestop', _data(data))
                   ...
                   .on('touchenter.mousestop', _mouseenter)
                   .on('mouseleave.mousestop', _mouseleave)
                   .on('touchleave.mousestop', _mouseleave)
                   .on('mousemove.mousestop', _mousemove)
                   .on('touchmove.mousestop', _mousemove);
        },
        teardown: function() {
